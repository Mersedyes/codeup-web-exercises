...
function isOdd(number){
    console.log('The odd ball number is ' + number);
    if (!(number % 2 == 0)){
        console.log(number + ' is odd!');
    } else {
        console.log(number + ' is not an odd ball!');
    }
}
//this runs the function to display
isOdd(3);
isOdd(-3);
isOdd(420);
isOdd(-420);
...
function isEven(number){
    console.log('The even steven number is ' + number);
    if (!(number % 2 == 0)){
        console.log(number + 'is not an even steven!');
    }
}
//this runs the function to display
isEven(3);
...
console.log(identity('Get into it yuh'));
console.log(identity(7));
console.log(identity('I\'m sorry Ms Jackson'));

// - Make a function named `isFive(input)`
function isFive(input){
    return input;
}
console.log(identity('yuh'));
console.log(identity(7));
console.log(identity('I\'m sorry Ms Jackson'));
