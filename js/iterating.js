...
/* SORT
sort works for strings and numbers
the case needs to be the same so it can put it in alpha*/
let instructors = ['Casey', 'DocRob', 'Ry', 'Jay', 'David'];
instructors.sort(); // will sort in alpha if they are the same case (lowercase is different than upper case)
console.log(instructors);
numbers.sort();
console.log(numbers);

/*Spliting and Joining
splitting breaks up the contents in the array
can do this on a string since it is immutable, splitting it will let you do more
joining brings the components of an array together
split and join are not like reduce array as they return the original string, it
creates a new array so we need new bucket
*/

let userInfo = "ry,sutton,08/11/1994/,ryasutton,ford,mustang";

//took this string and split it up
//let userInfoArray = userInfo.split(',');
let userInfoArray = userInfo.split('') // this would split everything in the array
console.log(userInfoArray);

//Join takes an array and jams them all together in an array
